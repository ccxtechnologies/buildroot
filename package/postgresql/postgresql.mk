...
POSTGRESQL_CPE_ID_VERSION = 11.22
...
ifeq ($(BR2_PACKAGE_POSTGRESQL_STATS),y)
define POSTGRESQL_BUILD_STATS
	$(TARGET_MAKE_ENV) $(MAKE) $(TARGET_CONFIGURE_OPTS) \
		$(POSTGRESQL_MAKE_OPTS) -C $(@D)/contrib/pg_stat_statements
endef
POSTGRESQL_POST_BUILD_HOOKS += POSTGRESQL_BUILD_STATS

define POSTGRESQL_INSTALL_STATS
	$(TARGET_MAKE_ENV) DESTDIR=$(TARGET_DIR) $(MAKE) install $(TARGET_CONFIGURE_OPTS) \
		$(POSTGRESQL_MAKE_OPTS) -C $(@D)/contrib/pg_stat_statements
endef
POSTGRESQL_POST_INSTALL_TARGET_HOOKS += POSTGRESQL_INSTALL_STATS
endif
endif
